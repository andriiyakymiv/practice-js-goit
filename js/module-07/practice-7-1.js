...
// const creEl = (document.createElement('p').textContent =
//   "Об'єктна модель документа (Document Object Model)");
// ref.title.after(creEl);
...
// const creElLi = document.createElement('li');
// creElLi.textContent = 'Властивість innerHTML';
// const creElH3 = document.createElement('h3');
// const creElP = document.createElement('p');
// creElP.textContent =
